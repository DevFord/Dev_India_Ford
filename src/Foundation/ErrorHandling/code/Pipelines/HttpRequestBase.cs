...
namespace FordIndia.Foundation.ErrorHandling.Pipelines
{
    public abstract class HttpRequestBase : HttpRequestProcessor
    {
        ...
        private bool PathNotIgnored(HttpRequestArgs hArgs)
        {
            ...
            var ignoredPath = ignoredPaths
                .Split(',')
                .Select(i => i.Trim())
                .Any(path => hArgs.HttpContext.Request.RawUrl.StartsWith(path, StringComparison.CurrentCultureIgnoreCase));
